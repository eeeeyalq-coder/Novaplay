...
Vous avez simplifié l'ajout de jeux ! Il suffit maintenant d'éditer l'array `GAMES_DATABASE` dans **script.js**.

## 📝 Ajouter un jeu simple

Ouvrez `script.js` et trouvez l'array `GAMES_DATABASE`. Ajoutez ceci avant la dernière accolade `];` :
